...
CREATE TABLE products (
    ...
    stock INT NOT NULL DEFAULT 0  -- Ajout de la colonne stock
);
...
('Le vaisseau de transport impérial', 'assets/VTICSER.jpg', 29.99, 383, '8+', 3), -- Stock faible
('La couronne', 'assets/LC.jpg', 9.99, 1194, '18+', 0); -- En rupture de stock
